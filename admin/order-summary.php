  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <button type="button" onclick="downloadPDF('<?= $orderDataRow['invoice_no']; ?>')" class="btn btn-warning">Download PDF</button>
      </div>
    </div>
  </div>
</div>
                               ...
                               <table style="width: 100%; border-collapse: collapse;" cellpadding="5">
                                     ...
                                     <thead>
                                        <tr>
                                            ...
                                            <th style="border-bottom: 1px solid #ccc; text-align: left;" width="10%">Price</th>
                                            <th style="border-bottom: 1px solid #ccc; text-align: left;" width="10%">Quantity</th>
                                            <th style="border-bottom: 1px solid #ccc; text-align: left;" width="5%">Total Price</th>
                                        </tr>
                                     </thead>
                                     <tbody>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-bottom: 1px solid #ccc; text-align: right; vertical-align: middle;"><?= $row['quantity'] ?></td>
